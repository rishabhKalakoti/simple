...
{
  "$end", "error", "$undefined", "NUM", "VAR", "END", "ENDL", "ARITHOP",
  "'='", "$accept", "stmt", "dec_list", "dec", "asst", "arith_exp", "term",
  "ENDLS", YY_NULLPTR
};
#endif
...
{
       9,    10,    13,    14,     1,     7,     6,    17,    16,     8
};

static const yytype_uint8 yycheck[] =
{
       3,     4,     6,     7,     4,     0,     8,     6,    14,     3
};
